 ...
 */
package com.thinkgem.jeesite.modules.dev.entity.devallwriteoff;
 ...
 * @version 2020-07-23
 */
public class DevAllWriteoff extends DataEntity<DevAllWriteoff> {
	...
	public DevAllWriteoff() {
		super();
	}

	public DevAllWriteoff(String id){
		super(id);
	}
