...
<body>
    ...
    <div style="background: url('${ctxStatic}/images/bk10.jpg') no-repeat;background-size:100% 100%;position: absolute;width: 100%;height: 100%;">
    ...
    <div class='alert alert-block' style="text-align:left;padding-bottom:10px;">
        ...
        <form id="loginForm" class="form-signin" action="${ctx}/login" method="post">
            ...
            <h3 style="color: black;font-weight:normal;text-align: center">登录</h3>
            ...
            <input class="btn btn-block login-btn btn-primary"  type="submit" value="登 录"/>&nbsp;&nbsp;
