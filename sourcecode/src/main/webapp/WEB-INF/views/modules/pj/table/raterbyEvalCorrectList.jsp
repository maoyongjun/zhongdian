...
<form:form id="searchForm" modelAttribute="pjProdBase" action="${ctx}/pj/eval/raterbyEvalCorrectList" method="post" class="breadcrumb form-search">
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <c:forEach items="${page.list}" var="pjProdBase">
        <tr>
            ...
            <td><a href="${ctx}/pj/eval/raterbyEvalCorrect?raterbyId=${pjProdBase.raterbyId}&note4=${pjProdBase.createDate}&note3=${pjProdBase.raterby.name}">
                    ${pjProdBase.title}
            </a></td>
            <td>
            ...
            <shiro:hasPermission name="pj:prodbase:pjProdBase:edit"><td>
                <a href="${ctx}/pj/eval/raterbyEvalCorrect?raterbyId=${pjProdBase.raterbyId}&note4=${pjProdBase.createDate}&note3=${pjProdBase.raterby.name}">修正</a>
