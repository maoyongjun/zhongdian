...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/dev/devall/devAll/">设备列表</a></li>
		<li class="active"><a href="${ctx}/dev/devall/devAll/form?id=${devAll.id}">设备<shiro:hasPermission name="dev:devall:devAll:edit">${not empty devAll.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="dev:devall:devAll:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="devAll" action="${ctx}/dev/devall/devAll/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="createdate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${devAll.createdate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="form-actions">
			<shiro:hasPermission name="dev:devall:devAll:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
