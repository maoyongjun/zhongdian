...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/dev/writeoffdetail/devWriteOffDetail/">核销单明细列表</a></li>
		<li class="active"><a href="${ctx}/dev/writeoffdetail/devWriteOffDetail/form?id=${devWriteOffDetail.id}">核销单明细<shiro:hasPermission name="dev:writeoffdetail:devWriteOffDetail:edit">${not empty devWriteOffDetail.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="dev:writeoffdetail:devWriteOffDetail:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="devWriteOffDetail" action="${ctx}/dev/writeoffdetail/devWriteOffDetail/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
