...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/dev/writeoff/devWriteOff/">核销单列表</a></li>
		<shiro:hasPermission name="dev:writeoff:devWriteOff:edit"><li><a href="${ctx}/dev/writeoff/devWriteOff/form">核销单添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="devWriteOff" action="${ctx}/dev/writeoff/devWriteOff/" method="post" class="breadcrumb form-search">
		...
		<c:forEach items="${page.list}" var="devWriteOff">
			<tr>
				...
				<shiro:hasPermission name="dev:writeoff:devWriteOff:edit"><td>
					...
					<a href="${ctx}/dev/writeoff/devWriteOff/sureWriteOff?id=${devWriteOff.id}&status=3">确认核销</a>
