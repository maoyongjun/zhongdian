...
<body>
	...
	<form:form id="inputForm" modelAttribute="devInWarehouse" action="${ctx}/dev/warehouse/devInWarehouse/save?type=${devInWarehouse.type}" method="post" class="form-horizontal">
		<form:hidden path="id"/>
