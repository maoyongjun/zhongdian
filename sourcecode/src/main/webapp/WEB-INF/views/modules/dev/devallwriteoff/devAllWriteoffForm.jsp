...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/dev/devallwriteoff/devAllWriteoff/">核销设备列表</a></li>
		<li class="active"><a href="${ctx}/dev/devallwriteoff/devAllWriteoff/form?id=${devAllWriteoff.id}">核销设备<shiro:hasPermission name="dev:devallwriteoff:devAllWriteoff:edit">${not empty devAllWriteoff.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="dev:devallwriteoff:devAllWriteoff:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="devAllWriteoff" action="${ctx}/dev/devallwriteoff/devAllWriteoff/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="cost" htmlEscape="false" maxlength="10" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">财务编号：</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="projectid" htmlEscape="false" maxlength="200" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="createdate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${devAllWriteoff.createdate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="control-group">
			<label class="control-label">卡车类型：</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="insurancedate" htmlEscape="false" maxlength="10" class="input-xlarge required"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="reviewdate" htmlEscape="false" maxlength="10" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="form-actions">
			<shiro:hasPermission name="dev:devallwriteoff:devAllWriteoff:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
